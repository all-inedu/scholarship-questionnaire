                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q11">
                                <input type="radio" name="answer[0]" id="q11" value="2"
                                    <?php echo e($retVal = !isset($personal_branding[0]) ? '' : ($personal_branding[0]['answer'] == '2' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q12">
                                <input type="radio" name="answer[0]" id="q12" value="0"
                                    <?php echo e($retVal = !isset($personal_branding[0]) ? '' : ($personal_branding[0]['answer'] == '0' ? 'checked' : '')); ?>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q16">
                                <input type="radio" name="answer[1]" id="q16" value="4"
                                    <?php echo e($retVal = !isset($personal_branding[1]) ? '' : ($personal_branding[1]['answer'] == '4' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q17">
                                <input type="radio" name="answer[1]" id="q17" value="0"
                                    <?php echo e($retVal = !isset($personal_branding[1]) ? '' : ($personal_branding[1]['answer'] == '0' ? 'checked' : '')); ?>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q21">
                                <input type="radio" name="answer[2]" id="q21" value="2"
                                    <?php echo e($retVal = !isset($personal_branding[2]) ? '' : ($personal_branding[2]['answer'] == '2' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q22">
                                <input type="radio" name="answer[2]" id="q22" value="0"
                                    <?php echo e($retVal = !isset($personal_branding[2]) ? '' : ($personal_branding[2]['answer'] == '0' ? 'checked' : '')); ?>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q26">
                                <input type="radio" name="answer[3]" id="q26" value="2"
                                    <?php echo e($retVal = !isset($personal_branding[3]) ? '' : ($personal_branding[3]['answer'] == '2' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q27">
                                <input type="radio" name="answer[3]" id="q27" value="0"
                                    <?php echo e($retVal = !isset($personal_branding[3]) ? '' : ($personal_branding[3]['answer'] == '0' ? 'checked' : '')); ?>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q29">
                                <input type="radio" name="answer[4]" id="q29" value="5"
                                    <?php echo e($retVal = !isset($personal_branding[4]) ? '' : ($personal_branding[4]['answer'] == '5' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q30">
                                <input type="radio" name="answer[4]" id="q30" value="0"
                                    <?php echo e($retVal = !isset($personal_branding[4]) ? '' : ($personal_branding[4]['answer'] == '0' ? 'checked' : '')); ?>
    ...
    <script>
        $("input[type=radio]").each(function() {
            $(this).on('change', function() {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(URL::to('/personal_brand_session')); ?>",
                    data: {
...
<?php echo $__env->make('utama.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quest\resources\views/questions/personal_brand.blade.php ENDPATH**/ ?>