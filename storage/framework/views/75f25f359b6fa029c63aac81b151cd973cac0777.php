                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q11">
                                <input required type="radio" name="answer[0]" id="q11" value="6"
                                    <?php if($yes_decision): ?>  <?php endif; ?>
                                    <?php echo e($retVal = !isset($yes_decision[0]) ? '' : ($yes_decision[0]['answer'] == '6' ? 'checked' : '')); ?> />
                            ...
                            <label class="quiz-form__ans" for="q12">
                                <input required type="radio" name="answer[0]" id="q12" value="4"
                                    <?php echo e($retVal = !isset($yes_decision[0]) ? '' : ($yes_decision[0]['answer'] == '4' ? 'checked' : '')); ?> />
                                <span class="design"></span>
                            ...
                            <label class="quiz-form__ans" for="q13">
                                <input required type="radio" name="answer[0]" id="q13" value="3"
                                    <?php echo e($retVal = !isset($yes_decision[0]) ? '' : ($yes_decision[0]['answer'] == '3' ? 'checked' : '')); ?> />
                                <span class="design"></span>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q18">
                                <input required type="radio" name="answer[2]" id="q18" value="5"
                                    <?php echo e($retVal = !isset($yes_decision[2]) ? '' : ($yes_decision[2]['answer'] == '5' ? 'checked' : '')); ?> />
                                <span class="design"></span>
                            ...
                            <label class="quiz-form__ans" for="q19">
                                <input required type="radio" name="answer[2]" id="q19" value="0"
                                    <?php echo e($retVal = !isset($yes_decision[2]) ? '' : ($yes_decision[2]['answer'] == '0' ? 'checked' : '')); ?> />
                                <span class="design"></span>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q20">
                                <input required type="radio" name="answer[3]" id="q20" value="3"
                                    <?php echo e($retVal = !isset($yes_decision[3]) ? '' : ($yes_decision[3]['answer'] == '3' ? 'checked' : '')); ?> />
                                <span class="design"></span>
                                <span class="text">Sudah</span>
                            </label>
                            <label class="quiz-form__ans" for="q21">
                                <input required type="radio" name="answer[3]" id="q21" value="0"
                                    <?php echo e($retVal = !isset($yes_decision[3]) ? '' : ($yes_decision[3]['answer'] == '0' ? 'checked' : '')); ?> />
                                <span class="design"></span>
    ...
    <script>
        $("input[type=radio]").each(function() {
            $(this).on('change', function() {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(URL::to('/akademik_yes_session')); ?>",
                    data: {
...
<?php echo $__env->make('utama.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quest\resources\views/questions/akademik_yes.blade.php ENDPATH**/ ?>