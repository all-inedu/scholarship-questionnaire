                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q11">
                                <input type="radio" name="answer[0]" id="q11" value="0"
                                    <?php echo e($retVal = !isset($aktivitas[0]) ? '' : ($aktivitas[0]['answer'] == '0' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q12">
                                <input type="radio" name="answer[0]" id="q12" value="1"
                                    <?php echo e($retVal = !isset($aktivitas[0]) ? '' : ($aktivitas[0]['answer'] == '1' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q14">
                                <input type="radio" name="answer[0]" id="q14" value="2"
                                    <?php echo e($retVal = !isset($aktivitas[0]) ? '' : ($aktivitas[0]['answer'] == '2' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q15">
                                <input type="radio" name="answer[0]" id="q15" value="3"
                                    <?php echo e($retVal = !isset($aktivitas[0]) ? '' : ($aktivitas[0]['answer'] == '3' ? 'checked' : '')); ?>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q16">
                                <input type="radio" name="answer[1]" id="q16" value="0"
                                    <?php echo e($retVal = !isset($aktivitas[1]) ? '' : ($aktivitas[1]['answer'] == '0' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q17">
                                <input type="radio" name="answer[1]" id="q17" value="2"
                                    <?php echo e($retVal = !isset($aktivitas[1]) ? '' : ($aktivitas[1]['answer'] == '2' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q18">
                                <input type="radio" name="answer[1]" id="q18" value="3"
                                    <?php echo e($retVal = !isset($aktivitas[1]) ? '' : ($aktivitas[1]['answer'] == '3' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q19">
                                <input type="radio" name="answer[1]" id="q19" value="4"
                                    <?php echo e($retVal = !isset($aktivitas[1]) ? '' : ($aktivitas[1]['answer'] == '4' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q20">
                                <input type="radio" name="answer[1]" id="q20" value="6"
                                    <?php echo e($retVal = !isset($aktivitas[1]) ? '' : ($aktivitas[1]['answer'] == '6' ? 'checked' : '')); ?>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q21">
                                <input type="radio" name="answer[2]" id="q21" value="0"
                                    <?php echo e($retVal = !isset($aktivitas[2]) ? '' : ($aktivitas[2]['answer'] == '0' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q22">
                                <input type="radio" name="answer[2]" id="q22" value="2"
                                    <?php echo e($retVal = !isset($aktivitas[2]) ? '' : ($aktivitas[2]['answer'] == '2' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q23">
                                <input type="radio" name="answer[2]" id="q23" value="3"
                                    <?php echo e($retVal = !isset($aktivitas[2]) ? '' : ($aktivitas[2]['answer'] == '3' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q24">
                                <input type="radio" name="answer[2]" id="q24" value="4"
                                    <?php echo e($retVal = !isset($aktivitas[2]) ? '' : ($aktivitas[2]['answer'] == '4' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q25">
                                <input type="radio" name="answer[2]" id="q25" value="6"
                                    <?php echo e($retVal = !isset($aktivitas[2]) ? '' : ($aktivitas[2]['answer'] == '6' ? 'checked' : '')); ?>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q26">
                                <input type="radio" name="answer[3]" id="q26" value="0"
                                    <?php echo e($retVal = !isset($aktivitas[3]) ? '' : ($aktivitas[3]['answer'] == '0' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q27">
                                <input type="radio" name="answer[3]" id="q27" value="2"
                                    <?php echo e($retVal = !isset($aktivitas[3]) ? '' : ($aktivitas[3]['answer'] == '2' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q28">
                                <input type="radio" name="answer[3]" id="q28" value="3"
                                    <?php echo e($retVal = !isset($aktivitas[3]) ? '' : ($aktivitas[3]['answer'] == '3' ? 'checked' : '')); ?>
                        ...
                        <div class="quiz-form__quiz">
                            ...
                            <label class="quiz-form__ans" for="q29">
                                <input type="radio" name="answer[4]" id="q29" value="7"
                                    <?php echo e($retVal = !isset($aktivitas[4]) ? '' : ($aktivitas[4]['answer'] == '7' ? 'checked' : '')); ?>
                            ...
                            <label class="quiz-form__ans" for="q30">
                                <input type="radio" name="answer[4]" id="q30" value="0"
                                    <?php echo e($retVal = !isset($aktivitas[4]) ? '' : ($aktivitas[4]['answer'] == '0' ? 'checked' : '')); ?>
                        ...
                        <div class="row tombol">
                            <div class="col-md-12">
                                <input class="submit back-button" type="button" value="Back"
                                    onclick="location.href='<?php echo e(Session::get('decision.answer') == 'No' ? '/akademik_no_view' : '/akademik_yes_view'); ?>'" />
    ...
    <script>
        $("input[type=radio]").each(function() {
            $(this).on('change', function() {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(URL::to('/aktivitas_session')); ?>",
                    data: {
...
<?php echo $__env->make('utama.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quest\resources\views/questions/aktivitas.blade.php ENDPATH**/ ?>